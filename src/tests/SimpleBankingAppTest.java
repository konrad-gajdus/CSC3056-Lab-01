...
public class SimpleBankingAppTest {
	...
	public static void testWithdrawals() {
        double balanceBefore = mainApp.getBalance("5495-1234");
        double withdrawalAmount = -65.87;

        // Exercise phase
        mainApp.addTransaction("5495-1234", withdrawalAmount);
        double balanceAfter = mainApp.getBalance("5495-1234");
        //adding a negative acts like subtraction
        ...
        //adding back the absolute value to set the system state back to where it was.
        mainApp.addTransaction("5495-1234", Math.abs(withdrawalAmount));
	}
